...
class SSFCapacityNeed(models.Model):
    ...
    provision_tenure_name = models.TextField(blank=True)
    provision_tenure_year = models.CharField(max_length=10, blank=True)
    provision_tenure_defined = models.CharField(max_length=50, blank=True)
    provision_tenure_additional = models.TextField(blank=True)
    provision_exclusive_name = models.TextField(blank=True)
    provision_exclusive_year = models.CharField(max_length=10, blank=True)
    provision_exclusive_defined = models.CharField(max_length=50, blank=True)
    provision_exclusive_additional = models.TextField(blank=True)
    provision_registration_name = models.TextField(blank=True)
    provision_registration_year = models.CharField(max_length=10, blank=True)
    provision_registration_defined = models.CharField(max_length=50, blank=True)
    provision_registration_additional = models.TextField(blank=True)
    provision_mcs_name = models.TextField(blank=True)
    provision_mcs_year = models.CharField(max_length=10, blank=True)
    provision_mcs_defined = models.CharField(max_length=50, blank=True)
    provision_mcs_additional = models.TextField(blank=True)
    provision_social_name = models.TextField(blank=True)
    provision_social_year = models.CharField(max_length=10, blank=True)
    provision_social_defined = models.CharField(max_length=50, blank=True)
    provision_social_additional = models.TextField(blank=True)
    provision_labour_name = models.TextField(blank=True)
    provision_labour_year = models.CharField(max_length=10, blank=True)
    provision_labour_defined = models.CharField(max_length=50, blank=True)
    provision_labour_additional = models.TextField(blank=True)
    provision_capacity_name = models.TextField(blank=True)
    provision_capacity_year = models.CharField(max_length=10, blank=True)
    provision_capacity_defined = models.CharField(max_length=50, blank=True)
    provision_capacity_additional = models.TextField(blank=True)
    provision_recognition_name = models.TextField(blank=True)
    provision_recognition_year = models.CharField(max_length=10, blank=True)
    provision_recognition_defined = models.CharField(max_length=50, blank=True)
    provision_recognition_additional = models.TextField(blank=True)
    provision_responsible_name = models.TextField(blank=True)
    provision_responsible_year = models.CharField(max_length=10, blank=True)
    provision_responsible_defined = models.CharField(max_length=50, blank=True)
    provision_responsible_additional = models.TextField(blank=True)
    provision_legal_name = models.TextField(blank=True)
    provision_legal_year = models.CharField(max_length=10, blank=True)
    provision_legal_defined = models.CharField(max_length=50, blank=True)
    provision_legal_additional = models.TextField(blank=True)
    provision_special_name = models.TextField(blank=True)
    provision_special_year = models.CharField(max_length=10, blank=True)
    provision_special_defined = models.CharField(max_length=50, blank=True)
    provision_special_additional = models.TextField(blank=True)
    provision_protection_name = models.TextField(blank=True)
    provision_protection_year = models.CharField(max_length=10, blank=True)
    provision_protection_defined = models.CharField(max_length=50, blank=True)
    provision_protection_additional = models.TextField(blank=True)

    legal_system = models.CharField(max_length=150, blank=True)
    legal_system_additional = models.TextField(blank=True)
    fisheries_legislation_title = models.TextField(blank=True)
    fisheries_legislation_year = models.CharField(max_length=10, blank=True)
    fisheries_legislation_amendments = models.TextField(blank=True)
    fisheries_legislation_sources = models.TextField(blank=True)
    national_policy_title = models.TextField(blank=True)
    national_policy_year = models.CharField(max_length=10, blank=True)
    national_policy_period_coverage = models.TextField(blank=True)
    national_policy_additional = models.TextField(blank=True)
    national_governmental_authority_name = models.TextField(blank=True)
    national_governmental_authority_sources = models.TextField(blank=True)
    national_governmental_type = models.CharField(max_length=50, blank=True)
    national_governmental_type_explanation = models.TextField(blank=True)
    national_governmental_support_document = models.TextField(blank=True)
    national_governmental_support_pages = models.TextField(blank=True)
    specifical_in_ssfcharge = models.TextField(blank=True)
    specifical_in_ssfcharge_sources = models.TextField(blank=True)

    communication_among_authority = models.CharField(max_length=10, blank=True)
    communication_among_authority_example = models.TextField(blank=True)
    communication_among_authority_additional = models.TextField(blank=True)
    communication_between_fishers = models.CharField(max_length=10, blank=True)
    communication_between_fishers_example = models.TextField(blank=True)
    communication_between_fishers_additional = models.TextField(blank=True)
    representation_required = models.CharField(max_length=10, blank=True)
    representation_required_example = models.TextField(blank=True)
    representation_required_additional = models.TextField(blank=True)
    participation_management = models.CharField(max_length=10, blank=True)
    participation_management_example = models.TextField(blank=True)
    participation_management_additional = models.TextField(blank=True)
    holistic_form = models.CharField(max_length=10, blank=True)
    holistic_form_example = models.TextField(blank=True)
    holistic_form_additional = models.TextField(blank=True)
