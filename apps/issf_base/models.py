...
class SSFKnowledge(models.Model):
    ...
    contributor = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='contributor+', 
...
class SelectedAttribute(models.Model):
    ...
    attribute = models.ForeignKey(Attribute, limit_choices_to=Q(
        attribute_type='Qualitative') | Q(attribute_type='Ordinal'), on_delete=models.CASCADE)
...
class SelectedThemeIssue(models.Model):
    ...
    issf_core = models.ForeignKey(ISSF_Core, db_column='issf_core_id',
            on_delete=models.CASCADE)
    theme_issue_value = models.ForeignKey(Theme_Issue_Value, db_column='theme_issue_value_id',
            on_delete=models.CASCADE)
