        ...
        if request.is_ajax():
            ...
            if form.is_valid():
                ...
                if not existing and not instance.core_record_type == 'Who\'s Who in SSF':
                    ...
                    url = 'https://dory.creait.mun.ca' + reverse(get_redirectname(instance.core_record_type), kwargs={'issf_core_id': issf_id})
        ...
        if request.is_ajax():
            ...
            if knowledge_form.is_valid() and knowledge_authors_form.is_valid() and author_count > 0:
                ...
                if not existing:
                    ...
                    api.PostUpdate('Check out the new #tbtiissf SOTA record for ' + name + '. ' + 'https://dory.creait.mun.ca/details/sota/' + issf_id)
    ...
    if request.method == 'POST':
        if request.is_ajax():
            ...
            if not existing:
                ...
                api.PostUpdate('Check out the new #tbtiissf SSF Organization record for ' + name + '. ' + 'https://dory.creait.mun.ca/details/organization/' + issf_id)
