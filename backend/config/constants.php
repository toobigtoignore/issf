...
return [
    ...
    'JUSTICE_TYPES' => [
        'types_of_justice_distributive' => "Distributive justice",
        'types_of_justice_social' => "Social justice",
        'types_of_justice_economic' => "Economic justice",
        'types_of_justice_market' => "Market justice",
        'types_of_justice_infrastructure' => "Infrastructure/wellbeing justice",
        'types_of_justice_regulatory' => "Regulatory justice",
        'types_of_justice_procedural' => "Procedural justice",
        'types_of_justice_environmental' => "Environmental justice",
        'covid_19_related' => "COVID-19 related justice"
    ],
