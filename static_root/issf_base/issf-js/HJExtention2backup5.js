        ...
        $('form.accordionFormsetGrowable').each(function () {
            ...
            for (i = 0; i < qualitativeAttributeNameList.length; i++) {
                ...
                for (j = 0; j < matchingRows.length; j++) {
                    ...
                    $(matchingRows[j]).children('td:nth-child(2)').text('');

                    //Insert button
                    if (matchingRows.length == 1) {
                        //if only 1 row, then append [add] button
                        var $addbutton = $('<button class="blueOrangeButton QualitativeButton medium radius" type="button">+</button>');
                        ...
                        var $deletebutton = $('<button class="orangeRedButton QualitativeButton medium radius" type="button">-</button>');
