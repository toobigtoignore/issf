...
var HJExtension = new function () {
    ...
    var DynamicFormSet = function () {
        ...
        $('.addFormSetButton').on('click', function (evt) {
            ...
            if ($newFormSet.children('table.advancedSearchPanelTabTable').length <= 0) {
                ...
                console.log("$newformset html: " + $newFormSet.html());

                //Regular form sets.
                $newFormSet.children().each(function () {
                    //console.log("Fix set num: " + numberOfSetsPresent);
    ...
    //---------------------------------------------------------
    //var _gq_addButtonHtml = '<button class="gqAddButton blueOrangeButton QualitativeButton medium radius" type="button"><i class="fi-[plus]">+</i></button>';
    ...
    var GrowableQualitativeSelection = function () {
        ...
        console.log('-->[init]GrowableQualitativeSelection');
        ...
        $('form.accordionFormsetGrowable').each(function () {
            ...
            console.log("----------Formset: " + $(this).attr('action') + "-------------");
            ...
            $form.find('tr.profile-attributes-row').each(function () {
                if ($(this).children('td[data-attr-type="Qualitative"]').length > 0) {
                    ...
                    //move the hidden input from <tr> to <td>, and place right after the <select>
    ...
    function mainCharacteristicsAddButtonHandler() {
        ...
        var deleteControl = $('<div class="deleteCheckBoxContainer"><input id="id_mainattributeview_set-' + newSetCount + '-DELETE" name="mainattributeview_set-' + newSetCount + '-DELETE" type="checkbox"></div>');
    ...
    function mainCharacteristicsDeleteButtonHandler() {
        ...
        console.log('Delete setcount: ' + setCount);
    ...
    var Util_FixSetNumber = function ($target, newSetCount) {
        ...
        //console.log('$target: ' + $('<div>').append( $target.clone() ).html());
