...
(function() {
  L.Control.NavBar = L.Control.extend({
    ...
    onAdd: function(map) {
      ...
      //map.once('moveend', function() {this._map.on('moveend', this._updateHistory, this);}, this);    //original
      //map.once('move', function() {this._map.on('move', this._updateHistory, this);}, this);
      //map.once('dragend', function() {this._map.on('dragend', this._updateHistory, this);}, this);
      //map.once('zoomend', function() {this._map.on('zoomend', this._updateHistory, this);}, this);
      //this._map.on('move', this._updateHistory, this);
